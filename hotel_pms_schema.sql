...
CREATE TABLE IF NOT EXISTS rooms (
    ...
    is_dnd BOOLEAN DEFAULT FALSE COMMENT 'Không làm phiền (Icon dấu trừ)',
    is_makeup_room BOOLEAN DEFAULT FALSE COMMENT 'Yêu cầu dọn phòng',
...
CREATE TABLE IF NOT EXISTS booking_rooms (
    ...
    is_priority BOOLEAN DEFAULT FALSE COMMENT 'Ưu tiên (Icon cờ đỏ)',
    is_priority_charge BOOLEAN DEFAULT FALSE COMMENT 'Ưu tiên tính phí (Icon ghim đen)',
...
-- 25.1. Bảng liên kết Đăng ký phòng với Yêu cầu đặc biệt (N-N)
CREATE TABLE IF NOT EXISTS booking_room_special_requests (
    id INT AUTO_INCREMENT PRIMARY KEY,
    booking_room_id INT NOT NULL COMMENT 'Khóa ngoại tới Booking Rooms',
    special_request_id INT NOT NULL COMMENT 'Khóa ngoại tới Special Requests',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    UNIQUE KEY uk_booking_room_req (booking_room_id, special_request_id),
